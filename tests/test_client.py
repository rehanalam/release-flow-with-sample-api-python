...
from release_flow_with_sample_api import (
    ReleaseFlowWithSampleAPI,
    APIResponseValidationError,
    AsyncReleaseFlowWithSampleAPI,
)
from release_flow_with_sample_api._types import Omit
from release_flow_with_sample_api._utils import asyncify
from release_flow_with_sample_api._models import BaseModel, FinalRequestOptions
from release_flow_with_sample_api._exceptions import (
    APIStatusError,
    APITimeoutError,
    APIResponseValidationError,
    ReleaseFlowWithSampleAPIError,
)
from release_flow_with_sample_api._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: ReleaseFlowWithSampleAPI | AsyncReleaseFlowWithSampleAPI) -> int:
...
class TestReleaseFlowWithSampleAPI:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_copy(self, client: ReleaseFlowWithSampleAPI) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_copy_signature(self, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_copy_build_request(self, client: ReleaseFlowWithSampleAPI) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "release_flow_with_sample_api/_legacy_response.py",
                        "release_flow_with_sample_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "release_flow_with_sample_api/_compat.py",
    ...
    def test_request_timeout(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_default_headers_option(self) -> None:
        test_client = ReleaseFlowWithSampleAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        ...
        test_client2 = ReleaseFlowWithSampleAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = ReleaseFlowWithSampleAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("api_key") == api_key

        with pytest.raises(ReleaseFlowWithSampleAPIError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = ReleaseFlowWithSampleAPI(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_request_extra_json(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(RELEASE_FLOW_WITH_SAMPLE_API_BASE_URL="http://localhost:5000/from/env"):
            client = ReleaseFlowWithSampleAPI(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: ReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = ReleaseFlowWithSampleAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = ReleaseFlowWithSampleAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = ReleaseFlowWithSampleAPI(
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: ReleaseFlowWithSampleAPI
    ) -> None:
    ...
    @mock.patch("release_flow_with_sample_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    @mock.patch("release_flow_with_sample_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: ReleaseFlowWithSampleAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: ReleaseFlowWithSampleAPI) -> None:
...
class TestAsyncReleaseFlowWithSampleAPI:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    async def test_raw_response_for_binary(
        self, respx_mock: MockRouter, async_client: AsyncReleaseFlowWithSampleAPI
    ) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        # options that have a default are overridden correctly
    ...
    async def test_copy_default_headers(self) -> None:
        client = AsyncReleaseFlowWithSampleAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        assert client.default_headers["X-Foo"] == "bar"
    ...
    def test_copy_signature(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncReleaseFlowWithSampleAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        ...
        test_client2 = AsyncReleaseFlowWithSampleAPI(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = AsyncReleaseFlowWithSampleAPI(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("api_key") == api_key

        with pytest.raises(ReleaseFlowWithSampleAPIError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncReleaseFlowWithSampleAPI(
    ...
    def test_multipart_repeating_array(self, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    async def test_base_url_env(self) -> None:
        with update_env(RELEASE_FLOW_WITH_SAMPLE_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncReleaseFlowWithSampleAPI(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncReleaseFlowWithSampleAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncReleaseFlowWithSampleAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=True
        )
        ...
        non_strict_client = AsyncReleaseFlowWithSampleAPI(
            base_url=base_url, api_key=api_key, _strict_response_validation=False
        )
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncReleaseFlowWithSampleAPI
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncReleaseFlowWithSampleAPI,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncReleaseFlowWithSampleAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncReleaseFlowWithSampleAPI) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
