...
class ReleaseFlowWithSampleAPI(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous ReleaseFlowWithSampleAPI client instance.
        ...
        if api_key is None:
            raise ReleaseFlowWithSampleAPIError(
        ...
        if base_url is None:
            base_url = os.environ.get("RELEASE_FLOW_WITH_SAMPLE_API_BASE_URL")
        if base_url is None:
...
class AsyncReleaseFlowWithSampleAPI(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncReleaseFlowWithSampleAPI client instance.
...
AsyncClient = AsyncReleaseFlowWithSampleAPI
