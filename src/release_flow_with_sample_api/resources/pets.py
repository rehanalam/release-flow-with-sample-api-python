...
class PetsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PetsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/rehanalam/release-flow-with-sample-api-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PetsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/rehanalam/release-flow-with-sample-api-python#with_streaming_response
        """
    ...
    def find_by_status(
        self,
        *,
        status: Literal["available", "pending", "sold", "pre-loved"] | Omit = omit,
        type: Literal["available", "pending", "sold", "pre-loved"] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
